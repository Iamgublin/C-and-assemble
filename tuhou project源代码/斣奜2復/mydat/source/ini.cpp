...
void first_ini(){
	...
	input_bullet_info(&bullet_info[1],22, 22, 6, 3.5,0);
	input_bullet_info(&bullet_info[2], 5,120,10, 2.0,0);
	...
	input_bullet_info(&bullet_info[11],35,32, 8, 1.5,0);
	input_bullet_info(&bullet_info[12],20,20,10, 5.0,0);
}
...
void ini(){
	...
	boss.appear_count[0]=200;//中ボスが出現する時刻(42)
