...
bool Setup()
{
	...
	tex[8] = vertex(10, -1, 10, 0, 1, 0, 0, 2);
	tex[9] = vertex(-10, -1, 10, 0, 1, 0, 0, 0);
	tex[10] = vertex(-10, -1, -10, 0, 1, 0, 2, 0);
	tex[11] = vertex(10, -1, -10, 0, 1, 0, 2, 2);
	tex[12] = vertex(10, 5, 10, 0, 1, 0, 0, 0);
	tex[13] = vertex(-10, 5, 10, 0, 1, 0, 0, 2);
	tex[14] = vertex(-10, 5, -10, 0, 1, 0, 2, 2);
	tex[15] = vertex(10, 5, -10, 0, 1, 0, 2, 0);
	ve->Unlock();
	WORD *indices;
