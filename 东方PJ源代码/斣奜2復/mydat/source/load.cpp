...
//	LoadDivGraph( "../dat/img/bullet/b6.png" , 10 , 10 , 1 , 17 , 19 , img_bullet[6] ) ;
	...
	LoadDivGraph( "../dat/img/bullet/b8.png" , 9 , 9 , 1 , 12 , 18 ,img_bullet[8] ) ;
	...
	LoadDivGraph( "../dat/img/bullet/b12.png" , 10 , 10 , 1 , 12 , 12 , img_bullet[12] ) ;
	...
	ChangeVolumeSoundMem( 20, sound_se[3] ) ;
	ChangeVolumeSoundMem( 80, sound_se[8] ) ;
	ChangeVolumeSoundMem( 80, sound_se[34] ) ;
	//(41)
	...
	font[0] = CreateFontToHandle( "HGP行書体" , 30 , 3 ,DX_FONTTYPE_ANTIALIASING_EDGE);
	font[1] = CreateFontToHandle( "HGP行書体" , 20 , 3 ,DX_FONTTYPE_ANTIALIASING_EDGE);
	font[2] = CreateFontToHandle( "Arial Black" , 60 , 3 ,DX_FONTTYPE_ANTIALIASING_EDGE,DX_CHARSET_DEFAULT);
	font[3] = CreateFontToHandle( "Arial Black" , 40 , 3 , DX_FONTTYPE_ANTIALIASING_EDGE);
	font[4] = CreateFontToHandle( "Arial Black" , 20 , 3 , DX_FONTTYPE_ANTIALIASING_EDGE,DX_CHARSET_DEFAULT);
	font[5] = CreateFontToHandle( "Arial Black" , 16 , 3 , DX_FONTTYPE_ANTIALIASING_EDGE);
	font[6] = CreateFontToHandle( "Arial Black" , 13 , 2 , DX_FONTTYPE_ANTIALIASING_EDGE);
	font[7] = CreateFontToHandle( "ＨＧＰ行書体" , 16 , 2 , DX_FONTTYPE_ANTIALIASING_EDGE);
	font[8] = CreateFontToHandle( "HGPｺﾞｼｯｸE" , 14 , 2 , DX_FONTTYPE_ANTIALIASING_EDGE);
	font[9] = CreateFontToHandle( "HGPｺﾞｼｯｸE" , 11 , 2 , DX_FONTTYPE_ANTIALIASING_EDGE);
	font[10] = CreateFontToHandle( "HGPｺﾞｼｯｸE" , 25 , 2 , DX_FONTTYPE_ANTIALIASING_EDGE);
	font[11] = CreateFontToHandle( "HGPｺﾞｼｯｸE" , 18 , 2 , DX_FONTTYPE_ANTIALIASING_EDGE);
}
